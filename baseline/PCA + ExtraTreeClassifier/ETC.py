...
base_etc = ExtraTreesClassifier(random_state=0)

param_grid = [ {'n_estimators': [25, 50, 100, 250], 'max_depth': [2, 4, 7, 10]}]
...
train_accuracy = best_etc.score(train_images_pca, train_labels_encoded)
test_accuracy = best_etc.score(test_images_pca, test_labels_encoded)

print(f"训练集准确率: {train_accuracy:.4f}")
print(f"测试集准确率: {test_accuracy:.4f}")

test_predictions = best_etc.predict(test_images_pca)
print("\n分类报告:")
...
joblib.dump(best_etc, 'etc_model.pkl')
